<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DSBNCho.ascx.cs" Inherits="iCare.WebApp.Modules.Laboratory.Pages.CapMa.DSBNCho" %>
<style type="text/css">
    .table-responsive {
        position: relative;
    }
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="site-checkbox">
                                        <input id="_cb1" name="checkbox" type="checkbox" />
                                        <label for="_cb1"></label>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="site-checkbox">
                                        <input id="_cb2" name="checkbox" type="checkbox" />
                                        <label for="_cb2"></label>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="site-checkbox">
                                        <input id="_cb3" name="checkbox" type="checkbox" />
                                        <label for="_cb3"></label>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="site-checkbox">
                                        <input id="_cb4" name="checkbox" type="checkbox" />
                                        <label for="_cb4"></label>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="site-checkbox">
                                        <input id="_cb5" name="checkbox" type="checkbox" />
                                        <label for="_cb5"></label>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="site-checkbox">
                                        <input id="_cb6" name="checkbox" type="checkbox" />
                                        <label for="_cb6"></label>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="site-checkbox">
                                        <input id="_cb7" name="checkbox" type="checkbox" />
                                        <label for="_cb7"></label>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="site-checkbox">
                                        <input id="_cb8" name="checkbox" type="checkbox" />
                                        <label for="_cb8"></label>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="site-checkbox">
                                        <input id="_cb9" name="checkbox" type="checkbox" />
                                        <label for="_cb9"></label>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="site-checkbox">
                                        <input id="_cb10" name="checkbox" type="checkbox" />
                                        <label for="_cb10"></label>
                                    </div>
                                </td>
